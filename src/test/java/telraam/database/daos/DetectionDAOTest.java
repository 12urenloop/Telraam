...
class DetectionDAOTest extends DatabaseTest {
    ...
    public void setUp() throws Exception {
        ...
        batonId1 = batonDAO.insert(new Baton("baton1", "testbmac"));
        beaconId1 = beaconDAO.insert(new Beacon("beacon1", "testmac"));
        exampleDetection =
    ...
    void testUpdateDoesUpdate() {
        ...
        int updatedRows = detectionDAO.update(exampleDetection);
