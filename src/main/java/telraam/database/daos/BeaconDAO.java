...
public interface BeaconDAO extends DAO<Beacon> {
    ...
    @Override
    @SqlUpdate("INSERT INTO beacon (name, distance_from_start, broken, url) VALUES (:name, :distanceFromStart, :isBroken, :url)")
    @GetGeneratedKeys({"id"})
    ...
    @Override
    @SqlUpdate("UPDATE beacon SET name = :name, distance_from_start = :distanceFromStart, broken = :isBroken, url = :url WHERE id = :id")
