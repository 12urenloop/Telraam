...
public class NostradamusV3 implements Positioner {
    private static final Logger logger = Logger.getLogger(NostradamusV3.class.getName());
    private final String SOURCE_NAME = "nostradamus_v3";
    ...
    public NostradamusV3(AppConfiguration configuration, Jdbi jdbi) {
        this.jdbi = jdbi;
        ...
        while (true) {
            ...
            for (TeamHandler team : teamHandlers.values()) {
                ...
                if (queue != null && !queue.isEmpty()) {
                    ...
                    positions.addAll(team.update(copy));
                }
            }
